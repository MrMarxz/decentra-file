            ...
            <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    <div className="flex-shrink-0 flex items-center">
                        <span className="text-2xl font-bold text-orange-300 pl-2 sm:pl-4">Decentra File</span>
                    </div>
                    <div className="flex items-center">
                        <div className="pr-2 sm:pr-4">
                            <ConnectButton
                                ...
                                client={client}
                                connectButton={{
                                    className: "!w-32 !h-10 !px-4 !py-2 !text-sm !font-medium !rounded-md !bg-orange-500 !text-white !hover:bg-orange-600 !focus:outline-none !focus:ring-2 !focus:ring-offset-2 !focus:ring-orange-500",
